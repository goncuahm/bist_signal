...
ticker_input = st.text_area(
    ...
    value="AKBNK.IS, ASELS.IS, THYAO.IS, BASGZ.IS, AFYON.IS, ENJSA.IS, EREGL.IS, AYEN.IS, PAGYO.IS, YGGYO.IS, TUPRS.IS, KRDMD.IS, SISE.IS, LOGO.IS, NTGAZ.IS, AKGRT.IS, GWIND.IS, ISCTR.IS, AKSA.IS, YUNSA.IS, DOAS.IS, SASA.IS",
    height=100
)
